...
class CustomerInvoiceDataBuilderTest {
    ...
    void testFromJsonString() throws IOException {
        ...
        assertEquals("A useful widget", items[0].getDescription());
    ...
    void testFromJsonBytes() throws IOException {
        ...
        assertEquals("An advanced gadget", items[0].getDescription());
    ...
    void testBuild() {
        ...
        assertEquals("A versatile thingamajig", itemsResult[0].getDescription());
